 ...
 */
public abstract class RleEncoder2<T extends Comparable<T>> extends Encoder {

    private static final Logger logger = LoggerFactory.getLogger(RleEncoder2.class);

    /**
     * we save all value in a array and calculate its bitwidth.
     */
    protected T[] values;

    /**
     * index of values in a array and calculate its bitwidth.
     */
