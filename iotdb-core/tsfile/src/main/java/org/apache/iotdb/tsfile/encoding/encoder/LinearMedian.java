...
public class LinearMedian {
    ...
    public static long getMedian(long[] S, int size) {
        return linearSelect(0, size - 1, S, size / 2);
    }

    //do linearSelect in a recursive way
    private static long linearSelect(int left, int right, long[] array, int k) {
    ...
    private static int partition(int left, int right, long[] array, int pIndex) {
    ...
    private static int pickCleverPivot(int left, int right, long[] array) {
        int n = array.length;
    ...
    private static int getMedianValue(int left, int right, long[] array) {
