...
//            for (int i = 0; i < writeIndex; i++) {
//                widthArray[getValueWidth(deltaBlockBuffer[i])]++;
//            }
//
//            // TODO: Real storage anomaly
//            int maxWidth = 0, cumNumber = 0;
//            int curCost, minCost = Integer.MAX_VALUE, exceedCost = 0, sizeWidth = getValueWidth(writeIndex);
//            int width = 64;
//            for (int curWidth = 64; curWidth > 0; curWidth--) {
//                if (maxWidth == 0 && widthArray[curWidth] != 0) {
//                    maxWidth = curWidth;
//                }
//                // storage cost
//                curCost = curWidth * (writeIndex - cumNumber) + ((maxWidth + sizeWidth) * cumNumber);
//                if (curCost < minCost) {
//                    minCost = curCost;
//                    width = curWidth;
//                    exceedCost = maxWidth * cumNumber;
//                }
//                cumNumber += widthArray[curWidth];
//            }
//            System.out.println("Exceeding Cost: " + exceedCost);
//            return width;
//        }
    }
}
