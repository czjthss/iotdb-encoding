 ...
 */
public abstract class STD1Decoder extends Decoder {
    ...
    public static class IntSTDDecoder extends STD1Decoder {
    ...
    public static class LongSTDDecoder extends STD1Decoder {
        ...
        private void readPack() {
            ...
            for (int i = 0; i < packNum; i++) {
                value = BytesUtils.bytesToLong(stdBuf, base + packWidth * i, packWidth); // ignore anomaly
